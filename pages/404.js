      ...
      <section className="w-full bg-gray-900 text-white py-16">
        <div className="text-center mb-8">
          ...
          <p className="text-left">
            The Mobo Gobbler remote-controlled turkey decoy will change the way you hunt forever.
            If a gobbler is out of range, drive the decoy to him and bring him right back to your setup.
            The old toms can’t resist! It works amazingly on field birds.
            <br /><br />
            Have you ever been hunting and had an old tom hang up with hens and stay just out of range?
            You can close the gap by driving the decoy to him. The old tom will feel challenged and follow the decoy back to you.
            <br /><br />
            Anyone can use this decoy! Any age or hunting level, this decoy is guaranteed to increase your success with turkey hunting.
            The Mobo Gobbler is lightweight and easily portable. If you change locations, just take out your straps, throw it on your back, and enjoy your hunt wherever you go.
          </p>
        </div>
