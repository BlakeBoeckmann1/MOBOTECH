      ...
      <main className="p-6 sm:p-10 space-y-6">
        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
          <div className="mr-6">
            ...
            <h2 className="text-[#053f14] ml-0.5">MOBOTECH Nft overviews</h2>
          </div>

          <div className="flex flex-wrap items-start justify-end -mb-3">
            <button className="inline-flex px-5 py-3 text-white bg-[#053f14] hover:bg[#053f14] focus:bg-[#074534] rounded-md ml-6 mb-3">
              <Edit />
              Manage dashboard
            </button>
            <button className="inline-flex px-5 py-3 text-white bg-[#053f14] hover:bg[#053f14] focus:bg-[#074534] rounded-md ml-6 mb-3">
